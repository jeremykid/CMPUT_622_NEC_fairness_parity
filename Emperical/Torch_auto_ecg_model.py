...
class ECG_Survival_ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.flatten = nn.Flatten()
        # self.dense_agsx = nn.Linear(2, 10)
        self.dense = nn.Linear(5120, num_classes)
...
# model = ECG_ResNet()
# def test():
#     N, in_channels, z = 64, 12, 4096
#     x = torch.randn((64, 12, 4096))
#     age_sex = torch.randn((64, 2))
#     print(model({0:x, 1:age_sex}).shape)
#     print("Success")
